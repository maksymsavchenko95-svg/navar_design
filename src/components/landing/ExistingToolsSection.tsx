...
import { ChatIcon, RecipeIcon, CartIcon, SparklesIcon } from "./LandingIcons";
    ...
    >
      <div className="landing-section-container">
        ...
        <p className="editorial-section-sub">
          {LANDING_CONTENT.antiPositioning.subtitle}
        </p>

        {/* 3 Compact Limitation Cards */}
        <div className="limitation-cards-grid">
          {LANDING_CONTENT.antiPositioning.cards.map((card, idx) => (
            <div key={idx} className="limitation-card">
              <div className="limitation-card-icon-box">
                {getIcon(card.icon)}
              </div>
        ...
        {/* Anti-positioning Highlight Banner */}
        <div className="antipos-banner-box">
          ...
          <h3 className="antipos-banner-lead">
            {LANDING_CONTENT.antiPositioning.bannerLead}
          </h3>

          <p className="antipos-banner-text">
            {LANDING_CONTENT.antiPositioning.bannerBody}
          </p>
        </div>
      </div>
    </section>
