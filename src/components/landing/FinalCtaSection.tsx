...
export function FinalCtaSection({ onLogin }: FinalCtaSectionProps) {
  const { ref, isInView } = useInView({ threshold: 0.2 });

  return (
    <section className={`landing-final-cta-section ${isInView ? "reveal-in" : ""}`} ref={ref} aria-label="Заклик до дії">
        ...
        <div className="final-cta-banner">
          ...
          <div className="final-cta-content">
            ...
            <h2 className="final-cta-headline">
              Готові побачити свій тиждень?
            </h2>

            <p className="final-cta-sub">
              Підключіть «Власний Рахунок», щоб отримати персональний збалансований план вечерь під ваш бюджет уже зараз.
            </p>
            ...
            <p className="final-cta-reassurance">
              {LANDING_CONTENT.brand.oauthNote}
            </p>
          </div>
        </div>
      </div>
