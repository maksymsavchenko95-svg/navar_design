...
import { SparklesIcon, ArrowRightIcon } from "./LandingIcons";
...
export function HeroSection({ onLogin }: HeroSectionProps) {
  ...
  // Calculate tilt angle easing from ~3.5deg to 0deg as user scrolls down the hero
  ...
  return (
    <section className="landing-hero-section" id="hero" aria-label="Вступ та головна пропозиція">
      <div className="landing-hero-container">
        ...
        {/* Right Column: High Polish CSS-Built Mock Plan-Result Card */}
        <div
        ...
        >
          <div className="hero-mock-card" id="hero-plan-mock">
            ...
            {/* Nutrition and Promo highlight pills */}
            ...
            {/* 3 Faux Dish Rows with macro tags & promotion tags */}
