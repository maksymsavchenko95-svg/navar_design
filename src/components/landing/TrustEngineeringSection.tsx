...
import { ShieldIcon, ScaleIcon, CodeIcon } from "./LandingIcons";
  ...
  return (
    ...
    >
      <div className="landing-section-container">
        ...
        {/* JSON-RPC Structured Trace Panel */}
        <div className="trace-terminal-card">
          ...
          <div className="terminal-content">
            <div className="terminal-block request">
              <div className="terminal-label">// 1. tools/call запит агента до інфраструктури «Сільпо»</div>
              <pre>
            ...
            <div className="terminal-block response">
              <div className="terminal-label">// 2. Детермінована перевірена відповідь MCP сервера</div>
              <pre>
